...
RichEditEventLogger::RichEditEventLogger(CRichEditCtrl * logger):
m_LogLevel(Debug)
{
...
RichEditEventLogger::~RichEditEventLogger()
{

}

void RichEditEventLogger::SetLogLevel(LogLevel logLevel)
{
...
void RichEditEventLogger::Clear()
{
	m_Logger->SetWindowText(_T(""));
}